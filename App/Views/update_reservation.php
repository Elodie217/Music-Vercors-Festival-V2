...
<body class="relative bg-[url('../../asset/medias/concert-852575_1920.jpg')] bg-cover bg-fixed bg-center">
    ...
    <form method="post" action="/cours/Music-Vercors-Festival-V2-dev/reservations/update" class="space-y-4">
...
<div>
    <input type="checkbox" name="tarifReduit" id="tarifreduitRadio" <?php if ($selectedPass->getTarifReduit_pass() == 1) echo 'checked'; ?>>
